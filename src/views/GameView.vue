      ...
      <div class="main-area flex-grow lg:w-1/2 xl:w-3/5">
        <div class="max-w-4xl mx-auto h-full">
          ...
          <ActionFeedback
            ...
            message="Der Praktikant ist überfordert und das Team unzufrieden. Die Stakeholder sind enttäuscht von der unprofessionellen Lösung."
            tip="Vermeide Quick-Fixes, die nur kurzfristig funktionieren. Besser ist es, nachhaltige Lösungen zu finden, die das Team unterstützt."
